...
#         fitted_model_sarima_f_list.append(sarima_f)
    ...
    y_hat_sarima_br_series.to_csv('../../assets/y_hats/univariate/y_hat_sarima_br_u.csv')
    y_hat_sarima_g_series.to_csv('../../assets/y_hats/univariate/y_hat_sarima_g_u.csv')
    y_hat_sarima_f_series.to_csv('../../assets/y_hats/univariate/y_hat_sarima_f_u.csv')
