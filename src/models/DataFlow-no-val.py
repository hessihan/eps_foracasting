...
#     y_hat_ml2_a10.to_csv("../../assets/y_hats/multivariate/y_hat_ml2_a10.csv")
    ...
    y_hat_ml1_a10 = dataflow_for(lambda d1, d2, d3: L1(d1, d2, d3, alpha=10), df, firm_list, test_periods)
...
#     y_hat_ml1_a10.to_csv("../../assets/y_hats/multivariate/y_hat_ml1_a10.csv")
    ...
    y_hat_ml1_a20 = dataflow_for(lambda d1, d2, d3: L1(d1, d2, d3, alpha=20), df, firm_list, test_periods)
    y_hat_ml1_a20.columns=["y_hat_ml1_a20"]
    y_hat_ml1_a20.to_csv("../../assets/y_hats/multivariate/y_hat_ml1_a20.csv")
    MAPEUB(y_test.values, y_hat_ml1_a20.values)
    LargeErrorRate(y_test.values, y_hat_ml1_a20.values)

    y_hat_ml1_a100 = dataflow_for(lambda d1, d2, d3: L1(d1, d2, d3, alpha=100), df, firm_list, test_periods)
    y_hat_ml1_a100.columns=["y_hat_ml1_a100"]
    y_hat_ml1_a100.to_csv("../../assets/y_hats/multivariate/y_hat_ml1_a100.csv")
    MAPEUB(y_test.values, y_hat_ml1_a100.values)
    LargeErrorRate(y_test.values, y_hat_ml1_a100.values)    

    y_hat_ml1_a1000 = dataflow_for(lambda d1, d2, d3: L1(d1, d2, d3, alpha=100), df, firm_list, test_periods)
    y_hat_ml1_a1000.columns=["y_hat_ml1_a1000"]
    y_hat_ml1_a1000.to_csv("../../assets/y_hats/multivariate/y_hat_ml1_a1000.csv")
    MAPEUB(y_test.values, y_hat_ml1_a1000.values)
    LargeErrorRate(y_test.values, y_hat_ml1_a1000.values)        
